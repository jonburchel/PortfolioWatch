...
dotnet publish "PortfolioWatch/PortfolioWatch.csproj" -c Release -r win-x64 --self-contained true -p:PublishSingleFile=true -p:IncludeNativeLibrariesForSelfExtract=true -o "$releaseDir/SelfContained"
